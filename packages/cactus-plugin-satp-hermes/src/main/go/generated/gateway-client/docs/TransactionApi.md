...
func main() {
    transactRequest := *openapiclient.NewTransactRequest("123e4567-e89b-12d3-a456-426614174000", "transfer", "network1", "network2", "100", "95", "BeneficiaryPubkey_example", "OriginatorPubkey_example", *openapiclient.NewTransactRequestSourceAsset("Owner_example", "Ontology_example", "ContractName_example", "ContractAddress_example"), *openapiclient.NewTransactRequestSourceAsset("Owner_example", "Ontology_example", "ContractName_example", "ContractAddress_example")) // TransactRequest | 
