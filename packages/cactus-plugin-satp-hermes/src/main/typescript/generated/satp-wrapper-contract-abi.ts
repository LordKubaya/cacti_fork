...
export type ContractContext = Web3ContractContext<
  SatpWrapperContractAbi,
  SatpWrapperContractAbiMethodNames,
  SatpWrapperContractAbiEventsContext,
  SatpWrapperContractAbiEvents
>;
export type SatpWrapperContractAbiEvents =
  | 'Assign'
  | 'Burn'
  | 'Changed'
  | 'Lock'
  ...
  | 'Unwrap'
  | 'Wrap';
export interface SatpWrapperContractAbiEventsContext {
  Assign(
    parameters: {
      filter?: {};
      fromBlock?: number;
...
export type SatpWrapperContractAbiMethodNames =
  | 'new'
  | 'assign'
  | 'bridge_address'
  | 'burn'
...
export interface SatpWrapperContractAbi {
  /**
   * Payable: false
   * Constant: false
