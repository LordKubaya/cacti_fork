...
import SATPContract from "./bridge/SATPContract.json";
import SATPWrapperContract from "./bridge/SATPWrapperContract.json";
...
const satpGatewayConfig: SATPGatewayConfig = {
  gid: gatewayIdentity,
  logLevel,
...
describe("SATP Test", () => {
  it("SATP Test", () => {
    const satpGateway = new SATPGateway(satpGatewayConfig, [besuConfig]);
  });
});
