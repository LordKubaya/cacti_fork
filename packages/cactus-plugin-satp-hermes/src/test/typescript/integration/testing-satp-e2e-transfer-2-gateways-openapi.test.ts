...
beforeAll(async () => {
...

  {
    ...
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-fabric-deploy-ledger-time",
      "Duration (ms)\n",
      `${endTime - startTime}`,
    );
    ...
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-fabric-deploy-contracts-time",
      "Duration (ms)\n",
      `${endTime1 - startTime1}`,
    );
  }

  {
    ...
    const endTime = new Date().getTime();
    writeToCSV(
      "/home/kubaya/Desktop/tests/gateway-besu-deploy-ledger-time",
      "Duration (ms)\n",
      `${endTime - startTime}`,
    );
    ...
    const endTime1 = new Date().getTime();
    writeToCSV(
      "/home/kubaya/Desktop/tests/gateway-besu-deploy-contracts-time",
      "Duration (ms)\n",
      `${endTime1 - startTime1}`,
    );
  }
...
describe("2 SATPGateway sending a token from Besu to Fabric using openApi to request transact method", () => {
  it("should realize a transfer", async () => {
    ...
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-db-migrate-time",
      "Duration (ms)\n",
    ...
    const startTimeGatewayCreation1 = new Date().getTime();
    sourceGateway = await factory.create(options1);
    const endTimeGatewayCreation1 = new Date().getTime();
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-source-gateway-creation-time",
      "Duration (ms)\n",
      `${endTimeGatewayCreation1 - startTimeGatewayCreation1}`,
    );
    ...
    const startTimeGatewayCreation2 = new Date().getTime();
    targetGateway = await factory.create(options2);
    const endTimeGatewayCreation2 = new Date().getTime();
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-target-gateway-creation-time",
      "Duration (ms)\n",
      `${endTimeGatewayCreation2 - startTimeGatewayCreation2}`,
    );
    ...
    const endTime = new Date().getTime();
    writeToCSV(
      "/home/kubaya/Desktop/tests/2-gateway-transact-time",
      "Duration (ms)\n",
      `${endTime - startTime}`,
    );
  ...
  writeToCSV(
    "/home/kubaya/Desktop/tests/2-gateway-e2e-time",
    "Duration (ms)\n",
